    ...
    public void onBindViewHolder(MyRecyclerViewHolder holder, int position) {
        ...
        holder.image1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((Activity)mContext).startActivityForResult(intent, VectorRoomActivity.getPicSearchRequestId());
                ((Activity)mContext).overridePendingTransition(R.anim.default_anim_in, R.anim.default_anim_out);
            }
        });
    }
